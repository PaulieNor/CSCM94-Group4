...
public class Controller implements Initializable {
    ...
    public void switchToChefAccount(ActionEvent event) throws IOException {
        String fxml = "";
        Connection connect = staffDatabase();
        try {
            Statement statement = connect.createStatement();
            ...
            while (resultSet.next()) {
                if (resultSet.getString("StaffType").equals("Cook")) {
                    fxml = ("Chef.fxml");
                    staffSession = resultSet.getString("StaffUsername");
                }
            }
    ...
    public void switchToWaiterAccount(ActionEvent event) throws IOException {
        String fxml = "";
        Connection connect = staffDatabase();
        try {
            Statement statement = connect.createStatement();
            ...
            while (resultSet.next()) {
                if (resultSet.getString("StaffType").equals("Waiter")) {
                    fxml = ("Waiter.fxml");
                    staffSession = resultSet.getString("StaffUsername");
                }
            }
    ...
    public void switchToDriverAccount(ActionEvent event) throws IOException {
        String fxml = "";
        Connection connect = staffDatabase();
        try {
            Statement statement = connect.createStatement();
            ...
            while (resultSet.next()) {
                if (resultSet.getString("StaffType").equals("Driver")) {
                    fxml = ("Driver.fxml");
                    staffSession = resultSet.getString("StaffUsername");
                }
            }
